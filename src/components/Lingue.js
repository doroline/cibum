import { testi } from '../constants';
function Lingue(props) {
    return(
        <>
            <h2>{testi[props.lingua].titolo}</h2>
            <p className="paragrafo">{testi[props.lingua].paragrafo}</p>
        </>
    )
  }
