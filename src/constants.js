export const testi = {
    ...
    en: {
        titolo: "Page Title",
        paragrafo: "In a distant land, behind the Parole mountains, far from the lands of Vocalia and Consonantia, random lyrics live. They live isolated in the town of Lettere, on the shores of the Semantic, an immense linguistic ocean. A small stream called Devoto Oli runs through those places, supplying them with all the regulations they need. It is a paradismatic land, a land of plenty where greedy portions of roasted propositions fly into the mouth of those who want them. Not once have random texts been dominated by the almighty punctuation, a truly non-spelling life."
    },
    es: {
        titolo: "Título de la página",
        paragrafo: "En una tierra lejana, detrás de las montañas Parole, lejos de las tierras de Vocalia y Consonantia, viven letras al azar. Viven aislados en el pueblo de Lettere, a orillas de la Semántica, un inmenso océano lingüístico. Un pequeño arroyo llamado Devoto Oli atraviesa esos lugares, proporcionándoles todas las regulaciones que necesitan. Es una tierra paradisíaca, una tierra de abundancia donde porciones codiciosas de propuestas asadas vuelan a la boca de quienes las quieren. Ni una sola vez los textos aleatorios han estado dominados por la puntuación todopoderosa, una vida verdaderamente sin ortografía."
    },
}
